...
export default function App() {
  ...
  // (Phase 2). Reading-guide state stays here for now — it has its own hook
  // (useReadingGuide) below that consumes it; future cleanup could move these
  // three slots into Bucket C, but they aren't part of Phase 2's scope.
  ...
  }, [writeTypographyVars, liveWriters, huePaletteRef]);
